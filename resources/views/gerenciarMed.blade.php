        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Med</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Med</li>
                    </ol>
                    <div class="row border border-2 rounded mb-2">
                        <div class="p-2">
                            <form class="row g-3 needs-validation" novalidate>
                                <div class="col-8">
                                    <label for="medico" class="form-label">Nome</label>
                                    <input type="text" autocomplete="off" class="form-control shadow-sm"
                                        list="datalistOptions" id="medico" placeholder="Digite o nome nome medico"
                                        name="medico" required="" onchange="myFunction()">
                                    <datalist id="datalistOptions">
                                        @foreach ($users as $key => $data)
                                            <option id="{{ $data->email }}" value="{{ $data->name }}">
                                                {{ $data->name }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-4">
                                    <label for="validationCustomUsername" class="form-label">Turno</label>
                                ...
                                <div class="col-4">
                                    <label for="validationCustom03" class="form-label">Andar</label>
